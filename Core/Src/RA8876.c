...
Unit: Pixel
It must be divisible by 4. PWDULX Bit [1:0] tie to internally.
...
Unit: Pixel.
It must be divisible by 4. PIW Bit [1:0] tie to internally.
...
Unit: Pixel
It must be divisible by 4. PWIULX Bit [1:0] tie to internally.
